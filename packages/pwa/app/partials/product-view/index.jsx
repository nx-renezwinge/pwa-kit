...
const ProductViewHeader = ({name, price, currency, category, type}) => {
    const intl = useIntl()
    ...
    return (
        <VStack mr={4} spacing={2} align="flex-start" marginBottom={[4, 4, 4, 0, 0]}>
            ...
            {/* Price */}
            <Skeleton isLoaded={price && type} width={32}>
        ...
        <Flex direction={'column'} data-testid="product-view">
            ...
            <Flex direction={['column', 'column', 'column', 'row']}>
                ...
                <VStack align="stretch" spacing={8} flex={1} marginBottom={[16, 16, 16, 0, 0]}>
                    ...
                    {/* Show set products */}
                    {type.set && product.setProducts && (
                        <VStack align="stretch" spacing={4}>
                            <Heading fontSize="xl" as="h3">
                                {intl.formatMessage({
                                    defaultMessage: 'Included products',
                                    id: 'product_view.heading.included_products'
                                })}
                            </Heading>
                            {product.setProducts.map((setProduct) => (
                                <ProductItem
                                    key={setProduct.id}
                                    product={{
                                        ...setProduct,
                                    ...
                                    showLoading={isSetProductLoading}
                                />
                            ))}
                        </VStack>
                    )}
                    ...
                    {(type.master || type.variant) && (
                        <Box>
                            ...
                            {/* Add to Cart and WIshlist Button for desktop versions */}
                            <Box display={['none', 'none', 'none', 'block']}>
                                {renderActionButtons()}
                            </Box>
                        </Box>
            ...
            {/* Add to Cart and Wishlist Button for mobile versions */}
            {(type.master || type.variant) && (
                <Box
                    position="fixed"
                    bg="white"
...
ProductView.propTypes = {
    ...
    isSetProductLoading: PropTypes.bool,
